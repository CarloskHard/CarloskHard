<!--
  ...
  AHA!!!! Caught you looking at the source code!   
  Don't worry, I do it too... Programmer's instinct haha.

    
  Since you're digging around here, you might as well send me a message, right? 
  Send me a connection request on LinkedIn and say: "sudo accept-request".
  That way I'll know you have superuser permissions and you pass my personal Turing Test. 🤖🚫

  Come on, I'll even leave you a joke:
  What does a developer do when they are drowning?
  They open a /pull request/! 🛟

  ...(I promise my code is better than my jokes)
...
<div align="center">
  <p>
    <a href="README.md">
      <img src="https://raw.githubusercontent.com/lipis/flag-icons/main/flags/4x3/es.svg" width="22" alt="ES"/> 
      <i>Versión en español aquí  </i>
      <img src="https://raw.githubusercontent.com/lipis/flag-icons/main/flags/4x3/es.svg" width="22" alt="ES"/>
    </a>
  </p>

  <h1>Hi! I'm Carlos Távora 👋</h1>
  <h3>Fullstack & Cross-Platform Developer | Clean Code Enthusiast</h3>
...
I've touched the whole spectrum, from setting up servers to leaving the frontend spotless. Here is a summary of my arsenal:
...
![Web Hosting](https://img.shields.io/badge/Web_Hosting-2C3E50?style=flat)

---

## 🚀 Featured Projects

### 🍽️[Platorama](#) *(In development - 2025)*
**The project:** My most ambitious personal project. A gastronomic social network that creates a space for users to manage their favorite spots and seek recommendations from friends.
**Technology:** Developed using *Clean Architecture* to share business logic and presentation across platforms.
*   **Frontend/App:** Android Studio + Compose Multiplatform + Kotlin.
*   **Backend/Auth:** Firebase (NoSQL and authentication).
*   **Local DB:** SQLite with Room as an abstraction layer.

### 🎨[Web Portfolio and E-Commerce (La Bicha Tattoo)](https://labichatattoo.es/) *(2025)*
**The project:** Freelance development of a complete platform for a tattoo artist, including an appointment system, an SEO-optimized portfolio, and an online store.
**Technology:** WordPress + WooCommerce.
*   *Note:* An example proving that in simple, fast-deployment projects (2 days), true power lies in knowing how to use established tools (CMS) to provide the best solution for the client without reinventing the wheel.
...
<div align="center">
  <h3>📫 Shall we talk?</h3>
  <p>Looking for a developer, or want to build your idea with me?</p>
  <p>Drop me a message on LinkedIn or through the contact form on my portfolio. I promise not to refactor your messages.</p>
  
  <p>
    <a href="https://www.linkedin.com/in/carlos-b-6a8a9a2b5/" target="_blank"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=flat&logo=linkedin&logoColor=white" alt="LinkedIn"/></a>&nbsp;&nbsp;<a href="http://212.227.94.151/" target="_blank"><img src="https://img.shields.io/badge/My_Portfolio-003B57?style=flat&logo=linux-terminal&logoColor=white" alt="Web Portfolio" /></a>
  </p>
  <br>
</div>
...
<div align="center">
  <p>
    <i>"Good code is like good music: it requires structure, practice, and knowing when to take a pause (or leave a comment)."</i> 🎷
  </p>
</div>
...
<!-- 
  ...
  Well, since we're here, admire this ascii:⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⡠⠂⠠⣦⢶⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣤⠤⣤⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣀⣀⡧⠯⠁⠘⣽⡿⣇⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢠⡟⠠⢶⣶⣿⣦⣄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣴⡛⣩⣵⡂⠀⢐⡒⡆⣿⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢘⡇⠸⣿⢋⣿⠟⠋⢁⡿⢠⠛⠠⠌⠉⣿⡿⣿⣿⡿⣿⠃⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⢿⣿⣷⢿⣿⣿⣿⣿⡟⠿⣿⣿⣿⣿⣿⣿⣿⣿⣿⢷⣧⣼⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
  ...
  (Now for real, no more secrets. Close this and go drop me a follow on LinkedIn).
-->
